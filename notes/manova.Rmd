...
The first example uses a dataset from @manly which consists of the measurements mandibles taken from a number of skulls for different species of dog. 

```{r, engine='scalainr', results='hide'}

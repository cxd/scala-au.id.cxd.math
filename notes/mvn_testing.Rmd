...
```{r, engine='scalainr', echo=FALSE, results='hide'}
...
val fileName2:String = "/Users/cd/Projects/scala/scala-au.id.cxd.math-gh-pages/scala-au.id.cxd.math/data/test_mandible_data.csv"
...
```{r results="asis"}
x <- scala["x"]
quantiles2 <- scala["quantiles2"]
distances2 <- scala["distSorted2"]
